...
defineProperty("starter_switch",     globalPropertyi("tu-154/switchers/eng/starter_switch"))
defineProperty("starter_eng_select", globalPropertyi("tu-154/switchers/eng/starter_eng_select"))
defineProperty("starter_mode",       globalPropertyi("tu-154/switchers/eng/starter_mode"))

defineProperty("starter_start", globalPropertyi("tu-154/buttons/eng/starter_start"))
defineProperty("starter_stop",  globalPropertyi("tu-154/buttons/eng/starter_stop"))

defineProperty("flight_start_1", globalPropertyi("tu-154/buttons/eng/flight_start_1"))
defineProperty("flight_start_2", globalPropertyi("tu-154/buttons/eng/flight_start_2"))
defineProperty("flight_start_3", globalPropertyi("tu-154/buttons/eng/flight_start_3"))

-- default datarefs and commands
defineProperty("sim_igniter1", globalProperty("sim/cockpit2/engine/actuators/igniter_on[0]"))
defineProperty("sim_igniter2", globalProperty("sim/cockpit2/engine/actuators/igniter_on[1]"))
defineProperty("sim_igniter3", globalProperty("sim/cockpit2/engine/actuators/igniter_on[2]"))

defineProperty("sim_ignition1", globalProperty("sim/cockpit2/engine/actuators/ignition_on[0]"))
...
defineProperty("eng_airvalve_1", globalPropertyf("tu-154/bleed/eng_airvalve_1"))
defineProperty("eng_airvalve_2", globalPropertyf("tu-154/bleed/eng_airvalve_2"))
defineProperty("eng_airvalve_3", globalPropertyf("tu-154/bleed/eng_airvalve_3"))

defineProperty("tank1_1", globalPropertyi("tu-154/fuel/pump_tank1_1_work"))
defineProperty("tank1_2", globalPropertyi("tu-154/fuel/pump_tank1_2_work"))
defineProperty("tank1_3", globalPropertyi("tu-154/fuel/pump_tank1_3_work"))
defineProperty("tank1_4", globalPropertyi("tu-154/fuel/pump_tank1_4_work"))
...
-- caps
defineProperty("engine_caps", globalPropertyi("tu-154/anim/engine_caps"))

-- time
-- The start sequence runs on tu-154/time/frame_time like every other system.
-- It used to time itself off sim/time/total_running_time_sec, which does not
-- stop for a pause: pausing for longer than START_SEQ_TIME during a start
-- tripped the automatic fuel cut-off below while X-Plane held the RPM frozen,
-- hanging the start.
defineProperty("frame_time",        globalPropertyf("tu-154/time/frame_time"))

-- results
defineProperty("starter_pressure", globalPropertyf("tu-154/start/starter_pressure"))
...
defineProperty("start_sys_work",   globalPropertyf("tu-154/start/start_sys_work"))
defineProperty("fuel_in_1", globalPropertyi("tu-154/start/fuel_in_1"))
defineProperty("fuel_in_2", globalPropertyi("tu-154/start/fuel_in_2"))
defineProperty("fuel_in_3", globalPropertyi("tu-154/start/fuel_in_3"))
...
defineProperty("eng_bleed_sov_2", globalProperty("sim/cockpit2/bleedair/actuators/engine_bleed_sov[1]"))
...
-- is arbitrary; the start times below just have to begin well outside
-- START_SEQ_TIME so no engine looks like it is mid-start at load.
local start_clock = 0

local eng1_start_time = start_clock - 100
local eng2_start_time = start_clock - 100
local eng3_start_time = start_clock - 100
...
function update()
	...
	start_clock = start_clock + passed
	local time_now = start_clock

	local blocked = get(engine_caps) == 1

	-- automatic fuel cut-off if the engine has not started
	...
	-- air pressure from the running engines
	...
	if power_sys then
		...
		-- pressure from the APU, with an rpm check
		local apu_contrib = 0
		local apu_n1_val   = get(apu_n1)
		...
		-- the beginning of the start process
	...
	----------------------------------------
	-- stop the starter (protection against a hang)
	...
	-- pressure drop in the start system
