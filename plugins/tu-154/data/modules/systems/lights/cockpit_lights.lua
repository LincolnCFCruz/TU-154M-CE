...
-- light outside
defineProperty("percent_lights_on", globalPropertyf("sim/graphics/scenery/percent_lights_on")) -- percentage of light in the nearby cities
...
-- 2 flood lighting of the right side panel
-- 3 flood lighting of the front panel
-- 4 flood lighting of the centre pedestal
-- 5 flood lighting of the front part of the overhead
-- 6 flood lighting of the rear part of the overhead
-- 7 flood lighting of the flight engineer's panel
-- 8 left flashlight
-- 9 cabin lighting


-- light for the left side panel
...
-- light for the right side panel
...
-- light for the front part of the overhead panel
...
-- light for the rear part of the overhead panel
...
-- light for the flight engineer's panel
...
defineProperty("l9_4", globalProperty("sim/weapons/Prad[4]")) set(l9_4, 2.5) --size
...
defineProperty("l11_4", globalProperty("sim/weapons/Qrad[4]")) set(l11_4, 2.5) --size
...
defineProperty("right_panel_int", globalPropertyf("tu-154/lights/right_panel_int"))   -- integral lighting brightness, copilot's panel
defineProperty("mid_right_panel_int", globalPropertyf("tu-154/lights/mid_right_panel_int"))  -- integral lighting brightness, centre front panel
defineProperty("ovhd_panel_int", globalPropertyf("tu-154/lights/ovhd_panel_int"))   -- integral lighting brightness, overhead panel
defineProperty("left_panel_flood", globalPropertyf("tu-154/lights/left_panel_flood"))   -- flood light brightness, left panel
defineProperty("right_panel_flood", globalPropertyf("tu-154/lights/right_panel_flood"))   -- flood light brightness, right panel
defineProperty("mid_panel_flood", globalPropertyf("tu-154/lights/mid_panel_flood"))   -- flood light brightness, centre panel
defineProperty("front_panel_flood", globalPropertyf("tu-154/lights/front_panel_flood"))   -- flood light brightness, front panel
defineProperty("ovhd_front_panel_flood", globalPropertyf("tu-154/lights/ovhd_front_panel_flood"))   -- flood light brightness, front part of the overhead
defineProperty("ovhd_back_panel_flood", globalPropertyf("tu-154/lights/ovhd_back_panel_flood"))   -- flood light brightness, rear part of the overhead
defineProperty("km_panel_flood", globalPropertyf("tu-154/lights/km_panel_flood"))   -- flight engineer's panel lighting brightness
defineProperty("eng_panel_flood", globalPropertyf("tu-154/lights/eng_panel_flood"))   -- flight engineer's panel lighting brightness
defineProperty("azs_panel_flood", globalPropertyf("tu-154/lights/azs_panel_flood"))   -- AZS panel lighting
defineProperty("left_spotlight_flood", globalPropertyf("tu-154/lights/left_spotlight_flood"))   -- left flashlight brightness


-- controls
defineProperty("cabinl_flood_set", globalPropertyi("tu-154/lights/cabinl_flood_set"))   -- cockpit lighting switch
...
defineProperty("left_panel_flood_set", globalPropertyf("tu-154/lights/left_panel_flood_set"))   -- flood light brightness control, left panel
defineProperty("right_panel_flood_set", globalPropertyf("tu-154/lights/right_panel_flood_set"))   -- flood light brightness control, right panel
defineProperty("mid_panel_flood_set", globalPropertyf("tu-154/lights/mid_panel_flood_set"))   -- flood light brightness control, centre panel

defineProperty("front_panel_flood_set", globalPropertyf("tu-154/lights/front_panel_flood_set"))   -- flood light brightness control, front panel
defineProperty("ovhd_front_panel_flood_set", globalPropertyf("tu-154/lights/ovhd_front_panel_flood_set"))   -- flood light brightness control, front part of the overhead
defineProperty("ovhd_back_panel_flood_set", globalPropertyf("tu-154/lights/ovhd_back_panel_flood_set"))   -- flood light brightness control, rear part of the overhead

defineProperty("eng_panel_flood_set", globalPropertyf("tu-154/lights/eng_panel_flood_set"))   -- flight engineer's panel lighting brightness control
defineProperty("km_panel_flood_set", globalPropertyf("tu-154/lights/km_panel_flood_set"))   -- flight engineer's panel lighting brightness control
defineProperty("azs_panel_flood_set", globalPropertyi("tu-154/lights/azs_panel_flood_set"))   -- AZS panel lighting switch
...
local light_coef_27 = (get(bus27_volt_left) + get(bus27_volt_right)) / (29 * 2) -- tune the brightness so that there is still some light at half power.
...
set(km_panel_flood, km_flood ^ 0.5)
