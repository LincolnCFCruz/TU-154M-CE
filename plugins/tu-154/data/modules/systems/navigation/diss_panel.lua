...
defineProperty("diss_mode_set", globalPropertyi("tu-154/nvu/diss_mode")) -- DISS mode. 0 - off, 1 - operate, 2 - memory, 10 - failure
...
-- lamps
defineProperty("diss_memory", globalPropertyf("tu-154/lights/diss_memory")) -- DISS memory
