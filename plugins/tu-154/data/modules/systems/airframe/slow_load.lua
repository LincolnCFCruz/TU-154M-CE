...
defineProperty("fuel_tanker", globalPropertyf("tu-154/anim/fuel_tanker")) -- hidden. +50..0 - driving up, 0 - standing next to the aircraft, 0..-50 - driving away	100
...
defineProperty("paylod_set", globalPropertyf("tu-154/payload/paylod_set")) -- needs loading
defineProperty("cg_set", globalPropertyf("tu-154/payload/cg_set")) -- needs loading

defineProperty("load_slow_btn",globalPropertyi("tu-154/payload/load_slow_btn")) -- load button
