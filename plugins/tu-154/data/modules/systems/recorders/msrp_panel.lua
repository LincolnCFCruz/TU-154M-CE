...
defineProperty("msrp_mlp_aux", globalPropertyf("tu-154/lights/small/msrp_mlp_aux")) -- MSRP. MLP additional
defineProperty("msrp_up2", globalPropertyf("tu-154/lights/small/msrp_up2")) -- MSRP. UP2
defineProperty("msrp_mars", globalPropertyf("tu-154/lights/small/msrp_mars")) -- MSRP. MARS

-- buttons
defineProperty("lamp_test_msrp", globalPropertyf("tu-154/buttons/lamp_test_msrp")) -- MSRP lamp test button

-- controlls
defineProperty("msrp_date_ten", globalPropertyi("tu-154/switchers/eng/msrp_date_ten")) -- MSRP date, day tens
...
local function set_date()
	...
	while true do
		...
		-- see msrp_logic.lua: recordings live under the plugin's output/ folder
		local filename = pluginDataDir.."/output/black_box/".. panel_numbers .. ".bbox"	
