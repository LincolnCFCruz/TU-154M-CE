...
-- controls
defineProperty("sd75_on", globalPropertyi("tu-154/switchers/ovhd/sd75_1_on")) -- switch on
defineProperty("curs_np_on", globalPropertyi("tu-154/switchers/ovhd/curs_np_on_1")) -- switch on


defineProperty("nav_mode", globalPropertyi("tu-154/switchers/nav_1_mode")) -- NAV1 mode. Capture - VOR-DME
defineProperty("nav_man_auto", globalPropertyi("tu-154/switchers/nav_1_man_auto")) -- manual - automatic mode
defineProperty("nav_mile_km", globalPropertyi("tu-154/switchers/nav_1_mile_km")) -- miles/km mode
defineProperty("nav_left", globalPropertyi("tu-154/rotary/ovhd/nav_1_left")) -- left knob
defineProperty("nav_right", globalPropertyi("tu-154/rotary/ovhd/nav_1_right")) -- right knob
defineProperty("nav_but_1", globalPropertyi("tu-154/buttons/ovhd/nav_1_but_1")) -- button 1
defineProperty("nav_but_2", globalPropertyi("tu-154/buttons/ovhd/nav_1_but_2")) -- button 2
defineProperty("nav_but_3", globalPropertyi("tu-154/buttons/ovhd/nav_1_but_3")) -- button 3

defineProperty("nav_course", globalPropertyi("tu-154/rotary/console/nav_1_course")) -- heading set knob
...
defineProperty("nav_pow_cc", globalPropertyf("tu-154/radio/nav1_pow_cc")) -- Kurs-MP current draw


-- results
defineProperty("vor_dme", globalPropertyf("tu-154/radio/vor_dme_1")) -- distance
defineProperty("vor_bear", globalPropertyf("tu-154/radio/vor_bear_1"))
...
defineProperty("nav_course_1", globalPropertyf("tu-154/rotary/console/nav_1_course_1"))
defineProperty("nav_course_10", globalPropertyf("tu-154/rotary/console/nav_1_course_10"))
defineProperty("nav_course_100", globalPropertyf("tu-154/rotary/console/nav_1_course_100"))


-- lamps
defineProperty("nav_to_lit", globalPropertyf("tu-154/lights/small/nav_1_to"))
...
if MASTER then
	...
	-- `and` binds tighter than `or`: without the parens a bearing above 90.01
	-- took this branch regardless of power and failure state.
