...
defineProperty("prox_trf_img", loadImage("tcas_marks.png", 358, 490, 18, 18))
defineProperty("ta_trf_img", loadImage("tcas_marks.png", 384, 490, 18, 18))
defineProperty("ra_trf_img", loadImage("tcas_marks.png", 407, 490, 18, 18))

-- arrows
defineProperty("blu_dn_img", loadImage("tcas_marks.png", 433, 490, 9, 18))
defineProperty("yel_dn_img", loadImage("tcas_marks.png", 445, 490, 9, 18))
defineProperty("red_dn_img", loadImage("tcas_marks.png", 457, 490, 9, 18))

defineProperty("blu_up_img", loadImage("tcas_marks.png", 470, 490, 9, 18))
defineProperty("yel_up_img", loadImage("tcas_marks.png", 482, 490, 9, 18))
defineProperty("red_up_img", loadImage("tcas_marks.png", 494, 490, 9, 18))

defineProperty("table_draw")

defineProperty("tcas_range_set", globalPropertyi("tu-154/tcas/range_set"))  -- distance on the display. 0 = 3, 1 = 5, 2 = 10, 3 = 18 nm
