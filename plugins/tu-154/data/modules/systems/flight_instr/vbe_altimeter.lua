...
defineProperty("brt_knob", globalPropertyf("tu-154/gauges/alt/vbe_brt_left"))  -- brightness knob
defineProperty("press_knob", globalPropertyi("tu-154/gauges/alt/vbe_press_knob_left"))  -- pressure knob
defineProperty("fl_knob", globalPropertyi("tu-154/gauges/alt/vbe_fl_knob_left"))  -- flight level knob
defineProperty("vbe_mode", globalPropertyi("tu-154/gauges/alt/vbe_mode_left"))  -- meters/feet mode

defineProperty("vbe_flightlevel", globalPropertyf("tu-154/gauges/alt/vbe_flightlevel_left"))  -- flight level
...
-- load images
defineProperty("scale_img", loadImage("vbe_scale.png", 0, 84, 424, 424))
defineProperty("green_img", loadImage("vbe_scale.png", 445, 452, 60, 60))
defineProperty("yellow_img", loadImage("vbe_scale.png", 445, 387, 60, 60))
defineProperty("hpa_rus_img", loadImage("vbe_scale.png", 441, 342, 68, 35))
defineProperty("hpa_eng_img", loadImage("vbe_scale.png", 441, 301, 68, 35))
defineProperty("borderg_img", loadImage("vbe_scale.png", 5, 4, 153, 50))
defineProperty("ft_img", loadImage("vbe_scale.png", 448, 257, 46, 35))
defineProperty("mtr_img", loadImage("vbe_scale.png", 448, 220, 46, 35))
defineProperty("ALT_img", loadImage("vbe_scale.png", 437, 178, 68, 33))
defineProperty("E_img", loadImage("vbe_scale.png", 442, 121, 27, 46))
defineProperty("minus_img", loadImage("vbe_scale.png", 442, 127, 27, 35))
defineProperty("needle_img", loadImage("vbe_scale.png", 178, 24, 320, 6))
defineProperty("digitsImage", loadImage("black_digit_strip.png", 12, 240, 40, 784))
defineProperty("bold_digitsImage", loadImage("bold_digit_strip.png", 12, 240, 40, 784))

-- sounds
local switcher_sound = loadSample('sounds/metal_switch.wav')
local vbe_alarm_snd = loadSample('sounds/vbe_alarm.wav')
...
if MASTER then 	
	...
	if power then
		...
		altitude_ft = vbe_MSL + (press_inHg - msl_press_inhg) * 1000  -- calculate barometric altitude in feet
	end
