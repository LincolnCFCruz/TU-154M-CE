...
defineProperty("bg", loadImage("UMETAR.png", 0, 207, 205, 305))
...
function draw()
 drawAll(components)
 drawBitmapText(font, 10, 264, METAR1, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
 drawBitmapText(font, 10, 237, METAR2, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
 drawBitmapText(font, 10, 210, METAR3, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
 drawBitmapText(font, 10, 183, METAR4, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
 drawBitmapText(font, 10, 156, METAR5, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
 drawBitmapText(font, 10, 129, METAR6, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
 drawBitmapText(font, 10, 92, input, TEXT_ALIGN_LEFT, {1.0, 1.0, 1.0})
