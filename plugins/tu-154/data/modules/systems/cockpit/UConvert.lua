...
defineProperty("bg", loadImage("UConvert.png", 0, 207, 205, 305))
...
defineProperty("kg", loadImage("UConvert.png", 6, 400, 31, 18))
defineProperty("lb", loadImage("UConvert.png", 6, 370, 31, 18))
defineProperty("km", loadImage("UConvert.png", 49, 400, 31, 18))
defineProperty("nm", loadImage("UConvert.png", 49, 370, 31, 18))
defineProperty("mps", loadImage("UConvert.png", 97, 400, 46, 18))
defineProperty("fpm", loadImage("UConvert.png", 97, 370, 46, 18))

defineProperty("hpa", loadImage("UConvert.png", 152, 399, 37, 18))
defineProperty("inhg", loadImage("UConvert.png", 153, 365, 44, 22))
defineProperty("mmhg", loadImage("UConvert.png", 134, 337, 62, 22))
