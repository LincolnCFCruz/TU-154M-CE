...
defineProperty("absu_at_dif", globalPropertyf("tu-154/absu_at_dif_left")) -- speed difference for the PKP indication
...
-- controls
defineProperty("pitch_corr_hdl", globalPropertyf("tu-154/gauges/ahz/pitch_corr_L")) -- AGR pitch correction, + right
defineProperty("pkp_on", globalPropertyi("tu-154/switchers/ovhd/pkp_left_on")) -- switch

defineProperty("pkp_fail", globalPropertyi("tu-154/bkk/pkp_fail_left")) -- signal from the BKK - PKP failure
...
defineProperty("power_cc", globalPropertyf("tu-154/bkk/pkp_left_power_cc")) -- PKP current draw
...
-- results
defineProperty("res_pitch", globalPropertyf("tu-154/gauges/ahz/pitch_L")) -- AGR pitch, + nose up
defineProperty("pitch_int", globalPropertyf("tu-154/gyro/ahz_pitch_int_L")) -- AGR pitch, + up

defineProperty("res_roll", globalPropertyf("tu-154/gauges/ahz/roll_L")) -- AGR roll, + right
defineProperty("res_roll_bkk", globalPropertyf("tu-154/bkk/pkp_roll_left")) -- AGR roll, + right

defineProperty("course_plank", globalPropertyf("tu-154/gauges/ahz/course_plank_L")) -- captain's AGD course bar + to the right
defineProperty("gs_plank", globalPropertyf("tu-154/gauges/ahz/gs_plank_L")) -- captain's AGD glideslope bar + up


defineProperty("dir_roll", globalPropertyf("tu-154/gauges/ahz/dir_roll_L")) -- captain's AGD roll director + to the right
defineProperty("dir_pitch", globalPropertyf("tu-154/gauges/ahz/dir_pitch_L")) -- captain's AGD pitch director + up


defineProperty("speed_plank", globalPropertyf("tu-154/gauges/ahz/speed_plank_L")) -- captain's AGD rate of change + up

defineProperty("dir_roll_flag", globalPropertyf("tu-154/gauges/ahz/dir_roll_flag_L")) -- captain's AGD roll director failure flag
