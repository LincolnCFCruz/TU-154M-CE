...
local pong_sound = loadSample('sounds/pong.wav') --
local sqr_sound = loadSample('sounds/square.wav') --
...
if screen_work then
	...
	drawBitmapText(text_font, 10, 350, "P: "..player.life, TEXT_ALIGN_LEFT, {1, 1, 1, 1})
	drawBitmapText(text_font, 100, 350, "LVL: "..level, TEXT_ALIGN_LEFT, {1, 1, 1, 1})
	drawBitmapText(text_font, 250, 350, "PTS: "..score, TEXT_ALIGN_LEFT, {1, 1, 1, 1})
	
	if game_lost then
		drawBitmapText(text_font, 130, 210, "GAME OVER", TEXT_ALIGN_LEFT, {1, 1, 1, 1})
		drawBitmapText(text_font, 40, 150, "PRESS MOD TO EXIT", TEXT_ALIGN_LEFT, {1, 1, 1, 1})
		drawBitmapText(text_font, 15, 100, "PRESS BUT2 TO RESET", TEXT_ALIGN_LEFT, {1, 1, 1, 1})
	end
	
	if not game_started then
		drawBitmapText(text_font, 160, 170, "LEVEL: "..level, TEXT_ALIGN_LEFT, {1, 1, 1, 1})
	end
