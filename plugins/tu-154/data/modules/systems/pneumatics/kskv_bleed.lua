...
defineProperty("msl_press_pas", globalPropertyf("sim/weather/region/sealevel_pressure_pas"))  -- XP12: pressure at sea level in Pa
...
defineProperty("engine_bleed_sov_1", globalProperty("sim/cockpit2/bleedair/actuators/engine_bleed_sov[0]")) -- engine bleed air valve opening
defineProperty("engine_bleed_sov_2", globalProperty("sim/cockpit2/bleedair/actuators/engine_bleed_sov[1]")) -- engine bleed air valve opening
defineProperty("engine_bleed_sov_3", globalProperty("sim/cockpit2/bleedair/actuators/engine_bleed_sov[2]")) -- engine bleed air valve opening
...
if MASTER then	
	...
	-- altitude coef
	local msl_press_inhg = get(msl_press_pas) / 3386.389  -- XP12: Pa -> inHg
