...
-- controls
defineProperty("pitch_corr_hdl", globalPropertyf("tu-154/gauges/ahz/pitch_corr_C")) -- AGR pitch correction, + right
defineProperty("agr_on", globalPropertyi("tu-154/switchers/ovhd/agr_on")) -- switch
...
-- results
defineProperty("res_pitch", globalPropertyf("tu-154/gauges/ahz/pitch_C")) -- AGR pitch, + nose up
defineProperty("res_roll", globalPropertyf("tu-154/gauges/ahz/roll_C")) -- AGR roll, + right

defineProperty("agr_cc", globalPropertyf("tu-154/ahz/agr_cc")) -- current


defineProperty("ahz_flag", globalPropertyf("tu-154/gauges/ahz/ahz_flag_C")) -- AGR pitch, + nose up
