...
defineProperty("cockpit_door", globalPropertyf("tu-154/anim/cockpit_door")) -- right emergency door position


defineProperty("eng_main_vol", globalPropertyf("sim/operation/sound/engine_volume_ratio")) -- volume control for the engines
defineProperty("main_sound_on", globalPropertyi("sim/operation/sound/sound_on")) -- sound switch
...
-- sounds files
local inn_middle_left_1 = loadSample('sounds/engines/inn_middle_left.wav')
local inn_middle_right_1 = loadSample('sounds/engines/inn_middle_right.wav')
local inn_starter_left_1 = loadSample('sounds/engines/inn_starter_left.wav')
local inn_starter_right_1 = loadSample('sounds/engines/inn_starter_right.wav')
local out_behind_left_1 = loadSample('sounds/engines/out_behind_left.wav')
local out_behind_right_1 = loadSample('sounds/engines/out_behind_right.wav')
local out_idle_left_1 = loadSample('sounds/engines/out_idle_left.wav')
local out_idle_right_1 = loadSample('sounds/engines/out_idle_right.wav')
local out_starter_left_1 = loadSample('sounds/engines/out_starter_left.wav')
local out_starter_right_1 = loadSample('sounds/engines/out_starter_right.wav')

local inn_middle_left_2 = loadSample('sounds/engines/inn_middle_left.wav')
local inn_middle_right_2 = loadSample('sounds/engines/inn_middle_right.wav')
local inn_starter_left_2 = loadSample('sounds/engines/inn_starter_left.wav')
local inn_starter_right_2 = loadSample('sounds/engines/inn_starter_right.wav')
local out_behind_left_2 = loadSample('sounds/engines/out_behind_left.wav')
local out_behind_right_2 = loadSample('sounds/engines/out_behind_right.wav')
local out_idle_left_2 = loadSample('sounds/engines/out_idle_left.wav')
local out_idle_right_2 = loadSample('sounds/engines/out_idle_right.wav')
local out_starter_left_2 = loadSample('sounds/engines/out_starter_left.wav')
local out_starter_right_2 = loadSample('sounds/engines/out_starter_right.wav')

local inn_middle_left_3 = loadSample('sounds/engines/inn_middle_left.wav')
local inn_middle_right_3 = loadSample('sounds/engines/inn_middle_right.wav')
local inn_starter_left_3 = loadSample('sounds/engines/inn_starter_left.wav')
local inn_starter_right_3 = loadSample('sounds/engines/inn_starter_right.wav')
local out_behind_left_3 = loadSample('sounds/engines/out_behind_left.wav')
local out_behind_right_3 = loadSample('sounds/engines/out_behind_right.wav')
local out_idle_left_3 = loadSample('sounds/engines/out_idle_left.wav')
local out_idle_right_3 = loadSample('sounds/engines/out_idle_right.wav')
local out_starter_left_3 = loadSample('sounds/engines/out_starter_left.wav')
local out_starter_right_3 = loadSample('sounds/engines/out_starter_right.wav')

local inn_apu_left = loadSample('sounds/engines/inn_apu_left.wav')
local inn_apu_right = loadSample('sounds/engines/inn_apu_right.wav')
local out_apu_left = loadSample('sounds/engines/out_apu_left.wav')
local out_apu_right = loadSample('sounds/engines/out_apu_right.wav')

local inn_reverse = loadSample('sounds/engines/inn_reverse.wav')
