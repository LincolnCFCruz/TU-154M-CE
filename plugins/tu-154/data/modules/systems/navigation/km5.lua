...
defineProperty("bus36_volt", globalPropertyf("tu-154/elec/bus36_volt_pts250_2")) -- 36 V bus voltage

-- failures
defineProperty("fail", globalPropertyf("tu-154/failures/tks_km1_fail")) -- failure

-- controls
defineProperty("km5_knob", globalPropertyf("tu-154/gauges/eng/km5_knob_1")) -- KM-5 knob


-- results
defineProperty("km5_scale", globalPropertyf("tu-154/gauges/eng/km5_scale_1")) -- KM-5 scale rotation
defineProperty("km5_needle", globalPropertyf("tu-154/gauges/eng/km5_needle_1")) -- KM5 needle

defineProperty("course_mk", globalPropertyf("tu-154/tks/course_mk_1")) -- heading on MK5

defineProperty("km5_cc", globalPropertyf("tu-154/tks/km5_1_cc")) -- KM-5 current draw
