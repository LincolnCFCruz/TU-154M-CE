...
defineProperty("show_nvu_panel",globalPropertyi("tu-154/panels/show_nvu_panel")) -- show the NVU panel
...
defineProperty("nav_1_to_lit", globalPropertyf("tu-154/lights/small/nav_1_to"))
defineProperty("nav_1_from_lit", globalPropertyf("tu-154/lights/small/nav_1_from"))

defineProperty("nav_2_to_lit", globalPropertyf("tu-154/lights/small/nav_2_to"))
defineProperty("nav_2_from_lit", globalPropertyf("tu-154/lights/small/nav_2_from"))


-- DISS
defineProperty("wind_set", globalPropertyf("tu-154/rotary/console/wind_set")) -- wind setting

defineProperty("wind_course_left", globalPropertyi("tu-154/button/console/wind_course_left")) -- wind direction set button
defineProperty("wind_course_ctr", globalPropertyi("tu-154/button/console/wind_course_ctr")) -- wind direction set button
defineProperty("wind_course_right", globalPropertyi("tu-154/button/console/wind_course_right")) -- wind direction set button

defineProperty("wind_spd_left", globalPropertyi("tu-154/button/console/wind_spd_left")) -- wind speed set button
defineProperty("wind_spd_ctr", globalPropertyi("tu-154/button/console/wind_spd_ctr")) -- wind speed set button
defineProperty("wind_spd_right", globalPropertyi("tu-154/button/console/wind_spd_right")) -- wind speed set button

defineProperty("diss_wind_course", globalPropertyf("tu-154/nvu/diss_wind_course")) -- wind direction from the DISS
defineProperty("diss_wind_spd", globalPropertyf("tu-154/nvu/diss_wind_spd")) -- wind speed from the DISS

defineProperty("diss_abs_angle_1", globalPropertyf("tu-154/gauges/misc/diss_abs_angle_1")) -- angle units drum
defineProperty("diss_abs_angle_10", globalPropertyf("tu-154/gauges/misc/diss_abs_angle_10")) -- angle units drum
defineProperty("diss_abs_angle_100", globalPropertyf("tu-154/gauges/misc/diss_abs_angle_100")) -- angle units drum
defineProperty("diss_plus_angle_1", globalPropertyf("tu-154/gauges/misc/diss_plus_angle_1")) -- angle units drum
defineProperty("diss_plus_angle_10", globalPropertyf("tu-154/gauges/misc/diss_plus_angle_10")) -- angle units drum
defineProperty("diss_minus_angle_1", globalPropertyf("tu-154/gauges/misc/diss_minus_angle_1")) -- angle units drum
defineProperty("diss_minus_angle_10", globalPropertyf("tu-154/gauges/misc/diss_minus_angle_10")) -- angle units drum
defineProperty("diss_wind_spd_1", globalPropertyf("tu-154/gauges/misc/diss_wind_spd_1")) -- angle units drum
defineProperty("diss_wind_spd_10", globalPropertyf("tu-154/gauges/misc/diss_wind_spd_10")) -- angle units drum
defineProperty("diss_wind_spd_100", globalPropertyf("tu-154/gauges/misc/diss_wind_spd_100")) -- angle units drum
...
-- images
defineProperty("bg_img", loadImage("nvu_tex.png", 0, 238, 636, 786))
defineProperty("bg_img_RUS", loadImage("nvu_tex_RUS.png", 0, 238, 636, 786))
...
defineProperty("big_scale", loadImage("nvu_tex.png", 644, 843, 176, 176))
defineProperty("small_scale", loadImage("nvu_tex.png", 836, 880, 102, 102))
defineProperty("handle_img", loadImage("nvu_tex.png", 955, 911, 45, 45))
defineProperty("switch_img", loadImage("nvu_tex.png", 648, 745, 42, 70))

defineProperty("white_digits", loadImage("white_digits.png", 12, 240, 40, 784))
defineProperty("white_digits_scale", loadImage("white_digits_scale.png", 12, 240, 40, 784))
defineProperty("yellow_digits", loadImage("yellow_digits.png", 12, 240, 40, 784))


defineProperty("sign_plane", loadImage("nvu_tex.png", 741, 790, 88, 18))
defineProperty("sign_point", loadImage("nvu_tex.png", 741, 763, 88, 18))
defineProperty("sign_beacon", loadImage("nvu_tex.png", 741, 735, 88, 18))

defineProperty("sign_plane_RUS", loadImage("nvu_tex_RUS.png", 741, 790, 88, 18))
defineProperty("sign_point_RUS", loadImage("nvu_tex_RUS.png", 741, 763, 88, 18))
defineProperty("sign_beacon_RUS", loadImage("nvu_tex_RUS.png", 741, 735, 88, 18))

defineProperty("sign_I", loadImage("nvu_tex.png", 741, 696, 26, 31))
defineProperty("sign_II", loadImage("nvu_tex.png", 777, 696, 26, 31))

defineProperty("black_plank", loadImage("nvu_tex.png", 850, 778, 60, 30))
