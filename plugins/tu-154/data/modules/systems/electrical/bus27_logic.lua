...
-- sources
defineProperty("bat_volt_1", globalPropertyf("tu-154/elec/bat_volt_1")) -- battery voltage
defineProperty("bat_volt_2", globalPropertyf("tu-154/elec/bat_volt_2")) -- battery voltage
defineProperty("bat_volt_3", globalPropertyf("tu-154/elec/bat_volt_3")) -- battery voltage
defineProperty("bat_volt_4", globalPropertyf("tu-154/elec/bat_volt_4")) -- battery voltage

defineProperty("bat_amp_1", globalPropertyf("tu-154/elec/bat_amp_1")) -- battery current
defineProperty("bat_amp_2", globalPropertyf("tu-154/elec/bat_amp_2")) -- battery current
defineProperty("bat_amp_3", globalPropertyf("tu-154/elec/bat_amp_3")) -- battery current
defineProperty("bat_amp_4", globalPropertyf("tu-154/elec/bat_amp_4")) -- battery current
...
defineProperty("bat_source_1", globalPropertyi("tu-154/elec/bat_is_source_1")) -- battery is the power source
defineProperty("bat_source_2", globalPropertyi("tu-154/elec/bat_is_source_2")) -- battery is the power source
defineProperty("bat_source_3", globalPropertyi("tu-154/elec/bat_is_source_3")) -- battery is the power source
defineProperty("bat_source_4", globalPropertyi("tu-154/elec/bat_is_source_4")) -- battery is the power source
...
defineProperty("vu1_volt", globalPropertyf("tu-154/elec/vu1_volt")) -- rectifier unit (VU) running
defineProperty("vu2_volt", globalPropertyf("tu-154/elec/vu2_volt")) -- rectifier unit (VU) running
defineProperty("vu_res_volt", globalPropertyf("tu-154/elec/vu_res_volt")) -- rectifier unit (VU) running
...
defineProperty("gear_defl", globalProperty("sim/flightmodel2/gear/tire_vertical_deflection_mtr[1]")) -- landing gear strut compression
...
defineProperty("buses_connected", globalPropertyi("tu-154/elec/bus_connected"))
...
-- during the APU start the buses are tied. batteries 3 and 4 switch over to the start while 1 and 2 keep feeding the 27 V buses.
-- if voltage is present on the 115/200 buses, all three VUs switch on automatically.

-- bool2int comes from core/glbl_func.lua (published on _G); this module used to
-- re-declare an identical copy, and an int2bool that nothing called.
		...
		if get(apu_start_seq) == 1 then -- APU starter work
			...
			elseif get(gear_defl) > 0.05 then -- battery source for starting APU on ground 
				...
				if bat_works_1 + bat_works_2 > 0 then -- only bat 1 and bat 2 gives power to buses. bat 3 and bat 4 gives power for APU starter
					...
					-- no live battery: report "no source", as the on-ground
					-- branch above does, instead of "batteries" at 0 V
					source_L = 0
					source_R = 0
					bus_volt_L = 0
					bus_volt_R = 0
