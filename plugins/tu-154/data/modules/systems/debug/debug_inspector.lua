...
--
-- Toggled by the command below or the menu strip's DBG cell, which is why the
-- handle is published as cw_panels.inspector. No drf_panels entry, so
-- updatePanels() never touches it.
--
-- Fixed at 1180 x 740: any other client area scales the panel by a
-- non-integer factor and blurs it (CLAUDE.md 9). y is 121, not 120, so a
-- geometry saved while the window was resizable is dropped.
-- ---------------------------------------------------------------------------
