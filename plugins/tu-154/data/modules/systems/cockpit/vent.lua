...
defineProperty("vent_1", globalPropertyf("tu-154/anim/cockpit_vent_1"))
defineProperty("vent_2", globalPropertyf("tu-154/anim/cockpit_vent_2"))
defineProperty("vent_3", globalPropertyf("tu-154/anim/cockpit_vent_3"))

--[[
tu-154/anim/cockpit_vent_1
tu-154/anim/cockpit_vent_2
tu-154/anim/cockpit_vent_3

--]]

defineProperty("vent_1_sw", globalPropertyi("tu-154/switchers/ovhd/vent_1"))
defineProperty("vent_2_sw", globalPropertyi("tu-154/switchers/ovhd/vent_2"))
defineProperty("vent_3_sw", globalPropertyi("tu-154/switchers/ovhd/vent_3"))

--[[
tu-154/switchers/ovhd/vent_1
tu-154/switchers/ovhd/vent_2
tu-154/switchers/ovhd/vent_3
...
local vent2_sound = loadSample('sounds/cockpit_fan.wav')
local vent3_sound = loadSample('sounds/cockpit_fan.wav')
