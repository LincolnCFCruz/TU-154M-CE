...
defineProperty("show_ohvd_panel",globalPropertyi("tu-154/panels/show_ohvd_panel")) -- show the overhead panel
...
defineProperty("auasp_on", globalPropertyi("tu-154/switchers/ovhd/auasp_on"))  -- overhead. AUASP
defineProperty("auasp_contr", globalPropertyi("tu-154/switchers/ovhd/auasp_contr"))  -- overhead. AUASP test
defineProperty("eup_on", globalPropertyi("tu-154/switchers/ovhd/eup_on"))  -- EUP switch
defineProperty("agr_on", globalPropertyi("tu-154/switchers/ovhd/agr_on"))  -- AGR switch
defineProperty("bkk_contr", globalPropertyi("tu-154/switchers/ovhd/bkk_contr"))  -- BKK test. -1 - 2, 0 - off, +1 - 1
defineProperty("bkk_on", globalPropertyi("tu-154/switchers/ovhd/bkk_on"))  -- BKK switch
defineProperty("sau_stu_on", globalPropertyi("tu-154/switchers/ovhd/sau_stu_on"))  -- SAU/STU switch
defineProperty("pkp_left_on", globalPropertyi("tu-154/switchers/ovhd/pkp_left_on"))  -- left PKP
defineProperty("pkp_right_on", globalPropertyi("tu-154/switchers/ovhd/pkp_right_on"))  -- 	right PKP
defineProperty("mgv_contr", globalPropertyi("tu-154/switchers/ovhd/mgv_contr"))  -- MGV test
defineProperty("tks_on_1", globalPropertyi("tu-154/switchers/ovhd/tks_on_1"))  -- TKS 1 switch
defineProperty("tks_on_2", globalPropertyi("tu-154/switchers/ovhd/tks_on_2"))  -- TKS 2 switch
defineProperty("tks_heat", globalPropertyi("tu-154/switchers/ovhd/tks_heat"))  -- GA heating
defineProperty("tks_corr_1", globalPropertyi("tu-154/switchers/ovhd/tks_corr_1"))  -- BGMK 2 - 1 correction
defineProperty("tks_corr_2", globalPropertyi("tu-154/switchers/ovhd/tks_corr_2"))  -- BGMK 2 - 2 correction
defineProperty("curs_pnp_mode_1", globalPropertyi("tu-154/switchers/ovhd/curs_pnp_mode_1"))  -- PNP heading mode. 0 = GMK, 1 = GPK
defineProperty("curs_pnp_mode_2", globalPropertyi("tu-154/switchers/ovhd/curs_pnp_mode_2"))  -- PNP heading mode. 0 = GMK, 1 = GPK
defineProperty("svs_on", globalPropertyi("tu-154/switchers/ovhd/svs_on"))  -- SVS switch
defineProperty("svs_heat", globalPropertyi("tu-154/switchers/ovhd/svs_heat"))  -- SVS heating
...
defineProperty("emerg_light_on", globalPropertyi("tu-154/switchers/ovhd/emerg_light_on"))  -- emergency lighting
defineProperty("curs_np_on_1", globalPropertyi("tu-154/switchers/ovhd/curs_np_on_1"))  -- Kurs MP 1
defineProperty("curs_np_on_2", globalPropertyi("tu-154/switchers/ovhd/curs_np_on_2"))  -- Kurs MP 2
defineProperty("tra_67_on", globalPropertyi("tu-154/switchers/ovhd/tra_67_on"))  -- TRA 67
...
defineProperty("rv5_1_on", globalPropertyi("tu-154/switchers/ovhd/rv5_1_on"))  -- RV5 1
defineProperty("rv5_2_on", globalPropertyi("tu-154/switchers/ovhd/rv5_2_on"))  -- RV5 2
defineProperty("vhf_1_on", globalPropertyi("tu-154/switchers/ovhd/vhf_1_on"))  -- VHF 1
defineProperty("vhf_2_on", globalPropertyi("tu-154/switchers/ovhd/vhf_2_on"))  -- VHF 2
...
defineProperty("micron_1_on", globalPropertyi("tu-154/switchers/ovhd/micron_1_on"))  -- Mikron 1
defineProperty("micron_2_on", globalPropertyi("tu-154/switchers/ovhd/micron_2_on"))  -- Mikron 2
defineProperty("spu_on", globalPropertyi("tu-154/switchers/ovhd/spu_on"))  -- SPU intercom
defineProperty("sgs_on", globalPropertyi("tu-154/switchers/ovhd/sgs_on"))  -- SGS
defineProperty("sd75_1_on", globalPropertyi("tu-154/switchers/ovhd/sd75_1_on"))  -- SD75 1
defineProperty("sd75_2_on", globalPropertyi("tu-154/switchers/ovhd/sd75_2_on"))  -- SD75 2
---
defineProperty("uvid_on", globalPropertyi("tu-154/switchers/ovhd/uvid_on"))  -- UVID switch
defineProperty("vbe_1_on", globalPropertyi("tu-154/switchers/ovhd/vbe_1_on"))  -- VBE 1
defineProperty("vbe_2_on", globalPropertyi("tu-154/switchers/ovhd/vbe_2_on"))  -- VBE 2
defineProperty("mars_on", globalPropertyi("tu-154/switchers/ovhd/mars_on"))  -- MARS

defineProperty("vent_1", globalPropertyi("tu-154/switchers/ovhd/vent_1"))  -- captain's fan
defineProperty("vent_2", globalPropertyi("tu-154/switchers/ovhd/vent_2"))  -- copilot's fan
defineProperty("vent_3", globalPropertyi("tu-154/switchers/ovhd/vent_3"))  -- flight engineer's fan

defineProperty("arm406", globalPropertyi("tu-154/switchers/ovhd/arm406"))  -- ARM 406
defineProperty("ushdb_mode_1", globalPropertyi("tu-154/switchers/ovhd/ushdb_mode_1"))  -- USHDB and SPU 1. 0 - ARK, 1 - VOR
defineProperty("ushdb_mode_2", globalPropertyi("tu-154/switchers/ovhd/ushdb_mode_2"))  -- USHDB and SPU 2. 0 - ARK, 1 - VOR

defineProperty("diss_on", globalPropertyi("tu-154/switchers/ovhd/diss_on")) -- DISS power
defineProperty("diss_mode", globalPropertyi("tu-154/switchers/ovhd/diss_mode")) -- DISS mode. 0 - sea, 1 - land
defineProperty("nvu_calc_set", globalPropertyi("tu-154/switchers/ovhd/nvu_calc_set")) -- dead reckoning. -1 - DISS check in flight, 0 - NVU from SVS, 1 - NVU from DISS
...
-- buttons
defineProperty("tks_signal_off", globalPropertyi("tu-154/buttons/ovhd/tks_signal_off"))  -- release of the TKS signal inhibit
defineProperty("svs_contr", globalPropertyi("tu-154/buttons/ovhd/svs_contr"))  -- SVS test button
...
defineProperty("nav_1_left", globalPropertyi("tu-154/rotary/ovhd/nav_1_left")) -- left knob
defineProperty("nav_1_right", globalPropertyi("tu-154/rotary/ovhd/nav_1_right")) -- right knob

defineProperty("nav_1_mile_km", globalPropertyi("tu-154/switchers/nav_1_mile_km")) -- miles/km mode

defineProperty("nav_1_but_1", globalPropertyi("tu-154/buttons/ovhd/nav_1_but_1")) -- button 1
defineProperty("nav_1_but_2", globalPropertyi("tu-154/buttons/ovhd/nav_1_but_2")) -- button 2
defineProperty("nav_1_but_3", globalPropertyi("tu-154/buttons/ovhd/nav_1_but_3")) -- button 3


defineProperty("nav_2", globalPropertyf("sim/cockpit2/radios/actuators/nav2_frequency_hz"))  -- set the frequency
defineProperty("nav_2_left", globalPropertyi("tu-154/rotary/ovhd/nav_2_left")) -- left knob
defineProperty("nav_2_right", globalPropertyi("tu-154/rotary/ovhd/nav_2_right")) -- right knob

defineProperty("nav_2_mile_km", globalPropertyi("tu-154/switchers/nav_2_mile_km")) -- miles/km mode

defineProperty("nav_2_but_1", globalPropertyi("tu-154/buttons/ovhd/nav_2_but_1")) -- button 1
defineProperty("nav_2_but_2", globalPropertyi("tu-154/buttons/ovhd/nav_2_but_2")) -- button 2
defineProperty("nav_2_but_3", globalPropertyi("tu-154/buttons/ovhd/nav_2_but_3")) -- button 3

-- VHF
defineProperty("vhf_1", globalPropertyf("sim/cockpit2/radios/actuators/com1_frequency_hz"))  -- set the frequency
defineProperty("vhf_1_left", globalPropertyi("tu-154/rotary/ovhd/vhf_1_left"))  -- knob
defineProperty("vhf_1_right", globalPropertyi("tu-154/rotary/ovhd/vhf_1_right"))  -- knob

defineProperty("vhf_2", globalPropertyf("sim/cockpit2/radios/actuators/com2_frequency_hz"))  -- set the frequency
defineProperty("vhf_2_left", globalPropertyi("tu-154/rotary/ovhd/vhf_2_left"))  -- knob
defineProperty("vhf_2_right", globalPropertyi("tu-154/rotary/ovhd/vhf_2_right"))  -- knob

-- ARK
defineProperty("ark_1_mode", globalPropertyi("tu-154/switchers/ovhd/ark_1_mode")) -- ARK 1 mode. 0 = off, 1 = compass, 2 = antenna, 3 = loop
defineProperty("ark_1_channel", globalPropertyi("tu-154/switchers/ovhd/ark_1_channel")) -- ARK 1 channel
defineProperty("ark_1_hundr_left", globalPropertyi("tu-154/switchers/ovhd/ark_1_hundr_left")) -- frequency hundreds 1 - 17
defineProperty("ark_1_tens_left", globalPropertyi("tu-154/switchers/ovhd/ark_1_tens_left")) -- frequency tens 1 - 10 (0)
defineProperty("ark_1_ones_left", globalPropertyi("tu-154/switchers/ovhd/ark_1_ones_left")) -- frequency units 0 - 9
defineProperty("ark_1_hundr_right", globalPropertyi("tu-154/switchers/ovhd/ark_1_hundr_right")) -- frequency hundreds 1 - 17
defineProperty("ark_1_tens_right", globalPropertyi("tu-154/switchers/ovhd/ark_1_tens_right")) -- frequency tens 1 - 10 (0)
defineProperty("ark_1_ones_right", globalPropertyi("tu-154/switchers/ovhd/ark_1_ones_right")) -- frequency units 0 - 9

defineProperty("ark_1_ramka", globalPropertyi("tu-154/buttons/ovhd/ark_1_ramka")) -- loop antenna button


defineProperty("ark_2_mode", globalPropertyi("tu-154/switchers/ovhd/ark_2_mode")) -- ARK 1 mode. 0 = off, 1 = compass, 2 = antenna, 3 = loop
defineProperty("ark_2_channel", globalPropertyi("tu-154/switchers/ovhd/ark_2_channel")) -- ARK 1 channel
defineProperty("ark_2_hundr_left", globalPropertyi("tu-154/switchers/ovhd/ark_2_hundr_left")) -- frequency hundreds 1 - 17
defineProperty("ark_2_tens_left", globalPropertyi("tu-154/switchers/ovhd/ark_2_tens_left")) -- frequency tens 1 - 10 (0)
defineProperty("ark_2_ones_left", globalPropertyi("tu-154/switchers/ovhd/ark_2_ones_left")) -- frequency units 0 - 9
defineProperty("ark_2_hundr_right", globalPropertyi("tu-154/switchers/ovhd/ark_2_hundr_right")) -- frequency hundreds 1 - 17
defineProperty("ark_2_tens_right", globalPropertyi("tu-154/switchers/ovhd/ark_2_tens_right")) -- frequency tens 1 - 10 (0)
defineProperty("ark_2_ones_right", globalPropertyi("tu-154/switchers/ovhd/ark_2_ones_right")) -- frequency units 0 - 9

defineProperty("ark_2_ramka", globalPropertyi("tu-154/buttons/ovhd/ark_2_ramka")) -- loop antenna button
...
-- SO72
defineProperty("transponder_mode", globalPropertyi("tu-154/switchers/ovhd/transponder_mode"))
defineProperty("transponder_control", globalPropertyi("tu-154/buttons/ovhd/transponder_control"))
defineProperty("transponder_sign", globalPropertyi("tu-154/buttons/ovhd/transponder_sign"))
defineProperty("transponder_but_1", globalPropertyi("tu-154/buttons/ovhd/transponder_but_1"))
defineProperty("transponder_but_2", globalPropertyi("tu-154/buttons/ovhd/transponder_but_2"))
defineProperty("transponder_but_3", globalPropertyi("tu-154/buttons/ovhd/transponder_but_3"))
defineProperty("transponder_but_4", globalPropertyi("tu-154/buttons/ovhd/transponder_but_4"))
defineProperty("transponder_emerg", globalPropertyi("tu-154/buttons/ovhd/transponder_emerg"))
defineProperty("transponder_emerg_cap", globalPropertyi("tu-154/buttons/ovhd/transponder_emerg_cap"))
defineProperty("xpdr_code", globalPropertyf("sim/cockpit/radios/transponder_code"))



-- caps
defineProperty("bkk_contr_cap", globalPropertyi("tu-154/switchers/ovhd/bkk_contr_cap"))  -- BKK test toggle cover
defineProperty("bkk_on_cap", globalPropertyi("tu-154/switchers/ovhd/bkk_on_cap"))  -- BKK switch cover
defineProperty("sau_stu_cap", globalPropertyi("tu-154/switchers/ovhd/sau_stu_cap"))  -- SAU STU switch cover
defineProperty("pkp_left_cap", globalPropertyi("tu-154/switchers/ovhd/pkp_left_cap"))  -- left PKP cover
defineProperty("pkp_right_cap", globalPropertyi("tu-154/switchers/ovhd/pkp_right_cap"))  -- right PKP cover
defineProperty("mgv_contr_cap", globalPropertyi("tu-154/switchers/ovhd/mgv_contr_cap"))  -- 	MGV test cover
...
-- lamps
defineProperty("heat_ok_1", globalPropertyf("tu-154/lights/small/heat_ok_1")) -- pitot heating healthy lamp
...
defineProperty("bkk_ok", globalPropertyf("tu-154/lights/small/bkk_ok")) -- BKK healthy lamp

defineProperty("transponder_red", globalPropertyf("tu-154/lights/small/transponder_red"))
defineProperty("transponder_green", globalPropertyf("tu-154/lights/small/transponder_green"))
...
defineProperty("bus36_volt_pts250_2", globalPropertyf("tu-154/elec/bus36_volt_pts250_2"))
defineProperty("bus36_volt_right", globalPropertyf("tu-154/elec/bus36_volt_right"))
...
-- load images
defineProperty("bg_img", loadImage("overhead_tex.png", 0, 11, 1458, 1013))

defineProperty("sw_dn_img", loadImage("overhead_tex.png", 1831, 909, 39, 100))
defineProperty("sw_up_img", loadImage("overhead_tex.png", 1871, 912, 39, 100))
defineProperty("sw_ctr_img", loadImage("overhead_tex.png", 1916, 946, 36, 36))

defineProperty("sw_left_img", loadImage("overhead_tex.png", 1624, 700, 100, 36))
defineProperty("sw_right_img", loadImage("overhead_tex.png", 1624, 660, 100, 36))

defineProperty("big_sw_dn_img", loadImage("overhead_tex.png", 1956, 909, 39, 102))
defineProperty("big_sw_up_img", loadImage("overhead_tex.png", 2000, 910, 39, 102))

defineProperty("red_cap_up", loadImage("overhead_tex.png", 1466, 848, 56, 42))
defineProperty("blue_cap_up", loadImage("overhead_tex.png", 1524, 746, 56, 42))
defineProperty("black_cap_up", loadImage("overhead_tex.png", 1466, 697, 56, 42))

defineProperty("em_light_cap_dn", loadImage("overhead_tex.png", 1467, 747, 56, 95))
defineProperty("mgv_ctr_cap_dn", loadImage("overhead_tex.png", 1523, 795, 56, 95))
defineProperty("pkp_right_cap_dn", loadImage("overhead_tex.png", 1578, 795, 56, 95))
defineProperty("pkp_left_cap_dn", loadImage("overhead_tex.png", 1634, 795, 56, 95))
defineProperty("sau_cap_dn", loadImage("overhead_tex.png", 1692, 795, 56, 95))
defineProperty("bkk_cap_dn", loadImage("overhead_tex.png", 1750, 795, 56, 95))
defineProperty("bkk_test_cap_dn", loadImage("overhead_tex.png", 1805, 795, 56, 95))
defineProperty("taws_main_cap_dn", loadImage("overhead_tex.png", 1467, 595, 56, 95))
defineProperty("taws_36_cap_dn", loadImage("overhead_tex.png", 1525, 595, 56, 95))

defineProperty("big_rotary_sw", loadImage("overhead_tex.png", 1788, 925, 27, 80))
defineProperty("small_rotary_sw", loadImage("overhead_tex.png", 1740, 925, 38, 80))


defineProperty("ark_big_num", loadImage("overhead_tex.png", 1473, 911, 108, 108))
defineProperty("ark_mid_num", loadImage("overhead_tex.png", 1594, 929, 72, 72))
defineProperty("ark_small_num", loadImage("overhead_tex.png", 1676, 940, 50, 50))

defineProperty("big_scale", loadImage("overhead_tex.png", 1889, 710, 159, 159))
defineProperty("tks_handle", loadImage("overhead_tex.png", 1866, 658, 47, 47))


defineProperty("small_lamp", loadImage("overhead_tex.png", 1825, 706, 19, 19))
defineProperty("tks_main_lamp", loadImage("overhead_tex.png", 1935, 663, 32, 32))
defineProperty("tks_aux_lamp", loadImage("overhead_tex.png", 1982, 663, 32, 32))

defineProperty("trans_cap_open", loadImage("overhead_tex.png", 1469, 543, 46, 32))
defineProperty("trans_cap_closed", loadImage("overhead_tex.png", 1469, 488, 46, 49))




-- rus tex
defineProperty("bg_img_RUS", loadImage("overhead_tex_RUS.png", 0, 11, 1458, 1013))

defineProperty("em_light_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1467, 747, 56, 95))
defineProperty("mgv_ctr_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1523, 795, 56, 95))
defineProperty("pkp_right_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1578, 795, 56, 95))
defineProperty("pkp_left_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1634, 795, 56, 95))
defineProperty("sau_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1692, 795, 56, 95))
defineProperty("bkk_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1750, 795, 56, 95))
defineProperty("taws_main_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1467, 595, 56, 95))
defineProperty("taws_36_cap_dn_RUS", loadImage("overhead_tex_RUS.png", 1525, 595, 56, 95))

defineProperty("big_scale_RUS", loadImage("overhead_tex_RUS.png", 1889, 710, 159, 159))

defineProperty("tks_main_lamp_RUS", loadImage("overhead_tex_RUS.png", 1935, 663, 32, 32))
defineProperty("tks_aux_lamp_RUS", loadImage("overhead_tex_RUS.png", 1982, 663, 32, 32))
