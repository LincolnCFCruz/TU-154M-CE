...
defineProperty("front_turn", globalPropertyf("tu-154/anim/lg/front_turn")) -- nose gear steering

defineProperty("main_pos_left", globalPropertyf("tu-154/anim/lg/main_pos_left")) -- left main gear position. 0-1 - extension, -1 -5 - damper compression
defineProperty("main_rot_left", globalPropertyf("tu-154/anim/lg/main_rot_left")) -- left bogie rotation on the ground. 0 - horizontal, -11 - in flight

defineProperty("main_pos_right", globalPropertyf("tu-154/anim/lg/main_pos_right")) -- right main gear position. 0-1 - extension, -1 -5 - damper compression
defineProperty("main_rot_right", globalPropertyf("tu-154/anim/lg/main_rot_right")) -- right bogie rotation on the ground

-- tail
defineProperty("rudder_anim", globalPropertyf("tu-154/anim/rudder_anim")) -- rudder deflection angle for the animation.

defineProperty("elev_anim_L", globalPropertyf("tu-154/anim/elev_anim_L")) -- elevator deflection angle
defineProperty("elev_anim_R", globalPropertyf("tu-154/anim/elev_anim_R")) -- elevator deflection angle
	
-- wings
defineProperty("wing_flx_right", globalPropertyf("tu-154/anim/wing_flx_right")) -- wing bend angle
defineProperty("wing_flx_left", globalPropertyf("tu-154/anim/wing_flx_left")) -- wing bend angle
...
defineProperty("cockpit_table_2", globalPropertyf("tu-154/anim/cockpit_table_2")) -- table

defineProperty("rise_chair_arm_L", globalPropertyf("tu-154/anim/rise_chair_arm_L")) -- raise the seat lever
defineProperty("rise_chair_arm_R", globalPropertyf("tu-154/anim/rise_chair_arm_R")) -- raise the seat lever
...
defineProperty("wing_tip_defl", globalProperty("sim/flightmodel2/wing/wing_tip_deflection_deg[0]")) -- wing bend
...
defineProperty("airspeed", globalPropertyf("sim/flightmodel/position/indicated_airspeed")) -- indicated airspeed
...
-- wiper
defineProperty("wiper_left", globalPropertyi("tu-154/switchers/wiper_left")) -- windscreen wiper mode selector. -1 - slow, 0 - off, +1 - fast	0
defineProperty("wiper_right", globalPropertyi("tu-154/switchers/wiper_right")) -- windscreen wiper mode selector. -1 - slow, 0 - off, +1 - fast	0
...
local window_open = loadSample('sounds/window_open.wav')
local window_close = loadSample('sounds/window_close.wav')
