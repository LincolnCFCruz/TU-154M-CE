...
defineProperty("bus115_volt_sel", globalPropertyi("tu-154/switchers/eng/bus115_volt_sel")) -- voltmeter source selector
defineProperty("bus115_volt_phase_sel", globalPropertyi("tu-154/switchers/eng/bus115_volt_phase_sel")) -- voltmeter source selector
defineProperty("bus115_amp_sel", globalPropertyi("tu-154/switchers/eng/bus115_amp_sel")) -- ammeter source selector
defineProperty("bus115_amp_phase_sel", globalPropertyi("tu-154/switchers/eng/bus115_amp_phase_sel")) -- ammeter source selector

defineProperty("gen_1_on", globalPropertyi("tu-154/switchers/eng/gen_1_on")) -- generator 1 switch. -1 = test, 0 = off, +1 = on
...
defineProperty("emerg_inv115_cap", globalPropertyi("tu-154/switchers/eng/emerg_inv115_cap")) -- emergency 115 V inverter

defineProperty("bus36_volt_sel", globalPropertyi("tu-154/switchers/eng/bus36_volt_sel")) -- 36 V voltmeter selector
defineProperty("pts250_sel", globalPropertyi("tu-154/switchers/eng/pts250_sel")) -- PTS250 selector. 0 - No.1, 1 - No.2
...
defineProperty("bus36_tr_right_to_left", globalPropertyi("tu-154/switchers/eng/bus36_tr_right_to_left")) -- right bus on tr1
...
defineProperty("pts250_on_cap", globalPropertyi("tu-154/switchers/eng/pts250_on_cap")) -- PTS-250 switch
defineProperty("pts250_mode_cap", globalPropertyi("tu-154/switchers/eng/pts250_mode_cap")) -- PTS-250 mode. auto - manual

defineProperty("bus27_volt_sel", globalPropertyi("tu-154/switchers/eng/bus27_volt_sel")) -- 27 V voltmeter selector
defineProperty("bus27_amp1_sel", globalPropertyi("tu-154/switchers/eng/bus27_amp1_sel")) -- 27 V ammeter selector
defineProperty("bus27_amp2_sel", globalPropertyi("tu-154/switchers/eng/bus27_amp2_sel")) -- 27 V ammeter selector

defineProperty("bus27_connect", globalPropertyi("tu-154/switchers/eng/bus27_connect")) -- 27 V bus tie
defineProperty("bus27_connect_cap", globalPropertyi("tu-154/switchers/eng/bus27_connect_cap")) -- 27 V bus tie
defineProperty("bus27_vu1", globalPropertyi("tu-154/switchers/eng/bus27_vu1")) -- VU1. -1 - standby, 0 - off, +1 - on.
defineProperty("bus27_vu2", globalPropertyi("tu-154/switchers/eng/bus27_vu2")) -- VU2. -1 - standby, 0 - off, +1 - on.
...
-- gauges
defineProperty("bus115_freq", globalPropertyf("tu-154/gauges/eng/bus115_freq")) -- 115 V bus frequency meter - angle
defineProperty("bus115_volt", globalPropertyf("tu-154/gauges/eng/bus115_volt")) -- 115 V bus voltmeter - angle
defineProperty("bus115_amp", globalPropertyf("tu-154/gauges/eng/bus115_amp")) -- 115 V bus ammeter - angle

defineProperty("bus36_volt", globalPropertyf("tu-154/gauges/eng/bus36_volt")) -- 36 V bus voltmeter - angle

defineProperty("bus27_volt", globalPropertyf("tu-154/gauges/eng/bus27_volt")) -- 36 V bus voltmeter - angle
defineProperty("bus27_amp1", globalPropertyf("tu-154/gauges/eng/bus27_amp1")) -- 36 V bus voltmeter - angle
...
-- sources  for gauges
-- bus 27v
defineProperty("bat_volt_1", globalPropertyf("tu-154/elec/bat_volt_1"))
defineProperty("bat_volt_2", globalPropertyf("tu-154/elec/bat_volt_2"))
defineProperty("bat_volt_3", globalPropertyf("tu-154/elec/bat_volt_3"))
defineProperty("bat_volt_4", globalPropertyf("tu-154/elec/bat_volt_4"))

defineProperty("bat_amp_1", globalPropertyf("tu-154/elec/bat_amp_1"))
defineProperty("bat_amp_2", globalPropertyf("tu-154/elec/bat_amp_2"))
defineProperty("bat_amp_3", globalPropertyf("tu-154/elec/bat_amp_3"))
defineProperty("bat_amp_4", globalPropertyf("tu-154/elec/bat_amp_4"))
...
defineProperty("vu1_amp", globalPropertyf("tu-154/elec/vu1_amp"))
defineProperty("vu2_amp", globalPropertyf("tu-154/elec/vu2_amp"))
defineProperty("vu_res_amp", globalPropertyf("tu-154/elec/vu_res_amp"))
...
defineProperty("bus36_volt_pts250_1", globalPropertyf("tu-154/elec/bus36_volt_pts250_1"))
defineProperty("bus36_volt_pts250_2", globalPropertyf("tu-154/elec/bus36_volt_pts250_2"))

-- bus 115/200v
defineProperty("gen1_volt", globalPropertyf("tu-154/elec/gen1_volt"))
defineProperty("gen2_volt", globalPropertyf("tu-154/elec/gen2_volt"))
defineProperty("gen3_volt", globalPropertyf("tu-154/elec/gen3_volt"))
defineProperty("gen4_volt", globalPropertyf("tu-154/elec/gen4_volt"))
...
-- lamps
defineProperty("lamp_apu_gen_on", globalPropertyf("tu-154/lights/small/apu_gen_on")) -- RAP connected
defineProperty("bus_npk_1", globalPropertyf("tu-154/lights/small/bus_npk_1")) -- left NPK buses on 3
defineProperty("bus_npk_2", globalPropertyf("tu-154/lights/small/bus_npk_2")) -- right NPK buses on 1
defineProperty("emerg_inv_115", globalPropertyf("tu-154/lights/small/emerg_inv_115")) -- emergency 115 V inverter

defineProperty("gen_fail_1", globalPropertyf("tu-154/lights/small/gen_fail_1")) -- generator not running
defineProperty("gen_fail_2", globalPropertyf("tu-154/lights/small/gen_fail_2")) -- generator not running
defineProperty("gen_fail_3", globalPropertyf("tu-154/lights/small/gen_fail_3")) -- generator not running

defineProperty("bus_connected", globalPropertyf("tu-154/lights/small/bus_connected")) -- buses tied
defineProperty("left_bus_use_bat", globalPropertyf("tu-154/lights/small/left_bus_use_bat")) -- left bus from the batteries
defineProperty("right_bus_use_bat", globalPropertyf("tu-154/lights/small/right_bus_use_bat")) -- right bus from the batteries

defineProperty("turn_off_bat_1", globalPropertyf("tu-154/lights/small/turn_off_bat_1")) -- switch the battery off
defineProperty("turn_off_bat_3", globalPropertyf("tu-154/lights/small/turn_off_bat_3")) -- switch the battery off
defineProperty("turn_off_bat_2", globalPropertyf("tu-154/lights/small/turn_off_bat_2")) -- switch the battery off
defineProperty("turn_off_bat_4", globalPropertyf("tu-154/lights/small/turn_off_bat_4")) -- switch the battery off

defineProperty("vu_on_1", globalPropertyf("tu-154/lights/small/vu_on_1")) -- VU1
defineProperty("vu_on_2", globalPropertyf("tu-154/lights/small/vu_on_2")) -- VU2
defineProperty("left_bus_on_tr2", globalPropertyf("tu-154/lights/small/left_bus_on_tr2")) -- left bus on tr 2
defineProperty("right_bus_on_tr1", globalPropertyf("tu-154/lights/small/right_bus_on_tr1")) -- right bus on tr 1
defineProperty("pts250_n1", globalPropertyf("tu-154/lights/small/pts250_n1")) -- PTS 250 not running
defineProperty("pts250_n2", globalPropertyf("tu-154/lights/small/pts250_n2")) -- PTS 250 on the bus

-- lamps sources
defineProperty("test_lamps", globalPropertyi("tu-154/buttons/lamp_test_apu")) -- APU panel lamp test button

defineProperty("gpu_work_bus", globalPropertyf("tu-154/elec/gpu_work"))
defineProperty("inv115_fail", globalPropertyf("tu-154/failures/inv115_fail"))


defineProperty("buses_connected", globalPropertyf("tu-154/elec/bus_connected"))
...
defineProperty("bat_therm_1", globalPropertyf("tu-154/elec/bat_therm_1")) -- battery temperature
defineProperty("bat_therm_2", globalPropertyf("tu-154/elec/bat_therm_2")) -- battery temperature
defineProperty("bat_therm_3", globalPropertyf("tu-154/elec/bat_therm_3")) -- battery temperature
defineProperty("bat_therm_4", globalPropertyf("tu-154/elec/bat_therm_4")) -- battery temperature
