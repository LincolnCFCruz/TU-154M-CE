...
-- gauges
defineProperty("kus_ias_left", globalPropertyf("tu-154/gauges/speed/kus_ias_left")) -- indicated airspeed on the captain's KUS730
defineProperty("kus_tas_left", globalPropertyf("tu-154/gauges/speed/kus_tas_left")) -- true airspeed on the captain's KUS730

defineProperty("kus_ias_right", globalPropertyf("tu-154/gauges/speed/kus_ias_right")) -- indicated airspeed on the copilot's KUS730
defineProperty("kus_tas_right", globalPropertyf("tu-154/gauges/speed/kus_tas_right")) -- true airspeed on the copilot's KUS730

defineProperty("kus_ias_eng", globalPropertyf("tu-154/gauges/speed/kus_ias_eng")) -- indicated airspeed on the flight engineer's KUS730
defineProperty("kus_tas_eng", globalPropertyf("tu-154/gauges/speed/kus_tas_eng")) -- true airspeed on the flight engineer's KUS730
...
defineProperty("var75", globalPropertyf("tu-154/gauges/alt/var75")) -- captain's variometer 75
defineProperty("var30", globalPropertyf("tu-154/gauges/alt/var30")) -- flight engineer's variometer 30

defineProperty("var30_cabin", globalPropertyf("tu-154/gauges/airbleed/cabin_vvi")) -- cabin variometer
defineProperty("cabin_diff", globalPropertyf("tu-154/gauges/airbleed/cabin_diff")) -- pressure differential
defineProperty("cabin_alt", globalPropertyf("tu-154/gauges/airbleed/cabin_alt")) -- cabin altitude

-- altimeters
defineProperty("vd15_alt_left", globalPropertyf("tu-154/gauges/alt/vd15_alt_left")) -- altitude on the captain's VD15
defineProperty("vd15_tri_needle_left", globalPropertyf("tu-154/gauges/alt/vd15_tri_needle_left")) -- correction needle on the captain's VD15
defineProperty("vd15_pressure_left", globalPropertyf("tu-154/gauges/alt/vd15_pressure_left")) -- pressure on the captain's VD15

defineProperty("vd15_alt_right", globalPropertyf("tu-154/gauges/alt/vd15_alt_right")) -- altitude on the copilot's VD15
defineProperty("vd15_tri_needle_right", globalPropertyf("tu-154/gauges/alt/vd15_tri_needle_right")) -- correction needle on the copilot's VD15
defineProperty("vd15_pressure_right", globalPropertyf("tu-154/gauges/alt/vd15_pressure_right")) -- pressure on the copilot's VD15

defineProperty("vd15_alt_eng", globalPropertyf("tu-154/gauges/alt/vd15_alt_eng")) -- altitude on the flight engineer's VD15
defineProperty("vd15_tri_needle_eng", globalPropertyf("tu-154/gauges/alt/vd15_tri_needle_eng")) -- correction needle on the flight engineer's VD15
...
local MASTER = get(ismaster) ~= 1
	...
	local cpt_VM15_alt = left_MSL * 0.3048 + (cpt_VM15_press - msl_press_inhg) * 1000 * 0.3048  -- calculate barometric altitude in meters
	
	-- Co-Pilot's altimeter VM15
	local copt_VM15_press = get(vd15_pressure_right) * 0.0393701
	local copt_VM15_alt = right_MSL * 0.3048 + (copt_VM15_press - msl_press_inhg) * 1000 * 0.3048  -- calculate barometric altitude in meters
	
	-- Engineer's altimeter VM15
	local eng_VM15_press = get(vd15_pressure_eng) * 0.0393701
	local eng_VM15_alt = right_MSL * 0.3048 + (eng_VM15_press - msl_press_inhg) * 1000 * 0.3048  -- calculate barometric altitude in meters
