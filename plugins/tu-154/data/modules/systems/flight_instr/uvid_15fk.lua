...
defineProperty("uvid_needle_left", globalPropertyf("tu-154/gauges/alt/uvid_needle_left"))  -- captain's UVID altimeter needle
defineProperty("uvid_feet_counter", globalPropertyf("tu-154/gauges/alt/uvid_feet_counter"))  -- units-of-feet counter drum
defineProperty("uvid_hundreads_counter", globalPropertyf("tu-154/gauges/alt/uvid_hundreads_counter"))  -- hundreds-of-feet counter drum
defineProperty("uvid_thousands_counter", globalPropertyf("tu-154/gauges/alt/uvid_thousands_counter"))  -- thousands-of-feet counter drum
defineProperty("uvid_tens_thousands_counter", globalPropertyf("tu-154/gauges/alt/uvid_tens_thousands_counter"))  -- tens-of-thousands-of-feet counter drum
defineProperty("uvid_pressure_knob", globalPropertyf("tu-154/gauges/alt/uvid_pressure_knob"))  -- pressure setting knob
defineProperty("uvid_pressure_one", globalPropertyf("tu-154/gauges/alt/uvid_pressure_one"))  -- pressure units
defineProperty("uvid_pressure_ten", globalPropertyf("tu-154/gauges/alt/uvid_pressure_ten"))  -- pressure tens
defineProperty("uvid_pressure_hund", globalPropertyf("tu-154/gauges/alt/uvid_pressure_hund"))  -- pressure hundreds
defineProperty("uvid_pressure_thous", globalPropertyf("tu-154/gauges/alt/uvid_pressure_thous"))  -- pressure thousands

defineProperty("uvid_on", globalPropertyi("tu-154/switchers/ovhd/uvid_on"))  -- UVID switch

defineProperty("sim_barometer_setting", globalPropertyf("sim/cockpit/misc/barometer_setting"))  -- UVID15 lamp
defineProperty("vd15_lamp", globalPropertyf("tu-154/lights/small/vd15_lamp"))  -- UVID15 lamp
...
function update()
	...
	if power27 and power115 and sw_on and get(uvid_fail) == 0 then
		...
		uvid_alt = left_MSL + (press_inHg - msl_press_inhg) * 1000  -- calculate barometric altitude in feet
	end
