...
defineProperty("lamp_test_2", globalPropertyi("tu-154/buttons/lamp_test_engines")) -- lamp test button on the fire panel	0
...
defineProperty("lamp_test_front", globalPropertyi("tu-154/buttons/lamp_test_front")) -- front panel lamp test button
...
defineProperty("fire_buzzer_cap", globalPropertyi("tu-154/switchers/eng/fire_buzzer_cap")) -- fire siren

-- lamps
defineProperty("smoke_1", globalPropertyf("tu-154/lights/fire/smoke_1")) -- smoke in the compartments
defineProperty("smoke_2", globalPropertyf("tu-154/lights/fire/smoke_2")) -- smoke in the compartments
defineProperty("smoke_zone2_left", globalPropertyf("tu-154/lights/fire/smoke_zone2_left")) -- smoke in the compartments
defineProperty("smoke_zone2_right", globalPropertyf("tu-154/lights/fire/smoke_zone2_right")) -- smoke in the compartments
defineProperty("smoke_zone3", globalPropertyf("tu-154/lights/fire/smoke_zone3")) -- smoke in the compartments
defineProperty("smoke_zone4", globalPropertyf("tu-154/lights/fire/smoke_zone4")) -- smoke in the compartments
defineProperty("smoke_zone5_left", globalPropertyf("tu-154/lights/fire/smoke_zone5_left")) -- smoke in the compartments
defineProperty("smoke_zone5_right", globalPropertyf("tu-154/lights/fire/smoke_zone5_right")) -- smoke in the compartments
defineProperty("smoke_zone6", globalPropertyf("tu-154/lights/fire/smoke_zone6")) -- smoke in the compartments

defineProperty("fire_eng_1", globalPropertyf("tu-154/lights/fire/fire_eng_1")) -- engine fire
defineProperty("fire_eng_2", globalPropertyf("tu-154/lights/fire/fire_eng_2")) -- engine fire
defineProperty("fire_eng_3", globalPropertyf("tu-154/lights/fire/fire_eng_3")) -- engine fire

defineProperty("overheat_eng_1", globalPropertyf("tu-154/lights/fire/overheat_eng_1")) -- engine overheat
defineProperty("overheat_eng_2", globalPropertyf("tu-154/lights/fire/overheat_eng_2")) -- engine overheat
defineProperty("overheat_eng_3", globalPropertyf("tu-154/lights/fire/overheat_eng_3")) -- engine overheat

defineProperty("fuel_off_eng_1", globalPropertyf("tu-154/lights/fire/fuel_off_eng_1")) -- fuel closed
defineProperty("fuel_off_eng_2", globalPropertyf("tu-154/lights/fire/fuel_off_eng_2")) -- fuel closed
defineProperty("fuel_off_eng_3", globalPropertyf("tu-154/lights/fire/fuel_off_eng_3")) -- fuel closed

defineProperty("check_overheat", globalPropertyf("tu-154/lights/fire/check_overheat")) -- check for overheat and smoke
defineProperty("fire_apu", globalPropertyf("tu-154/lights/fire/fire_apu")) -- APU fire
defineProperty("turn_on_spz", globalPropertyf("tu-154/lights/fire/turn_on_spz")) -- switch on the SPZ


defineProperty("button_fire_eng_1", globalPropertyf("tu-154/lights/button/fire_eng_1")) -- engine 1 fire extinguishing
defineProperty("button_fire_eng_2", globalPropertyf("tu-154/lights/button/fire_eng_2")) -- engine 2 fire extinguishing
defineProperty("button_fire_eng_3", globalPropertyf("tu-154/lights/button/fire_eng_3")) -- engine 3 fire extinguishing
defineProperty("button_fire_apu", globalPropertyf("tu-154/lights/button/fire_apu")) -- APU fire extinguishing
defineProperty("button_fire_ng", globalPropertyf("tu-154/lights/button/fire_ng")) -- neutral gas fire extinguishing
defineProperty("button_fire_turn_3", globalPropertyf("tu-154/lights/button/fire_turn_3")) -- engine 3 fire extinguishing
defineProperty("button_fire_turn_2", globalPropertyf("tu-154/lights/button/fire_turn_2")) -- engine 2 fire extinguishing
defineProperty("button_fire_turn_1", globalPropertyf("tu-154/lights/button/fire_turn_1")) -- engine 1 fire extinguishing


defineProperty("throttle_1_fire", globalPropertyf("tu-154/lights/small/throttle_1_fire")) -- fire lamp on the throttle
defineProperty("throttle_2_fire", globalPropertyf("tu-154/lights/small/throttle_2_fire")) -- fire lamp on the throttle
defineProperty("throttle_3_fire", globalPropertyf("tu-154/lights/small/throttle_3_fire")) -- fire lamp on the throttle

defineProperty("fire_lamp", globalPropertyf("tu-154/lights/fire")) -- FIRE
...
defineProperty("engine_fuel_cut_1", globalPropertyi("tu-154/fire/engine_fuel_cut_1")) -- fuel shut off
defineProperty("engine_fuel_cut_2", globalPropertyi("tu-154/fire/engine_fuel_cut_2")) -- fuel shut off
defineProperty("engine_fuel_cut_3", globalPropertyi("tu-154/fire/engine_fuel_cut_3")) -- fuel shut off
...
local function swichers_check()
	...
	if fire_buzzer_cap_sw ~= fire_buzzer_cap_last then playSample(cap_sound, false) end
