...
defineProperty("needle_mins_1", globalPropertyf("tu-154/gauges/acs1/needle_mins"))

defineProperty("flight_timer_hours_1", globalPropertyf("tu-154/gauges/acs1/flight_timer_hours"))
defineProperty("flight_timer_mins_1", globalPropertyf("tu-154/gauges/acs1/flight_timer_mins"))

defineProperty("stopwatch_mins_1", globalPropertyf("tu-154/gauges/acs1/stopwatch_mins"))
defineProperty("needle_secs_1", globalPropertyf("tu-154/gauges/acs1/needle_secs"))

defineProperty("LK1", globalPropertyi("tu-154/gauges/acs1/left_knob_press"))
defineProperty("RK1", globalPropertyi("tu-154/gauges/acs1/right_knob_press"))
defineProperty("flag_pos_1", globalPropertyi("tu-154/gauges/acs1/flag_pos"))

-- clock 2 - copilot
defineProperty("needle_hours_2", globalPropertyf("tu-154/gauges/acs2/needle_hours"))
defineProperty("needle_mins_2", globalPropertyf("tu-154/gauges/acs2/needle_mins"))

defineProperty("flight_timer_hours_2", globalPropertyf("tu-154/gauges/acs2/flight_timer_hours"))
defineProperty("flight_timer_mins_2", globalPropertyf("tu-154/gauges/acs2/flight_timer_mins"))

defineProperty("stopwatch_mins_2", globalPropertyf("tu-154/gauges/acs2/stopwatch_mins"))
defineProperty("needle_secs_2", globalPropertyf("tu-154/gauges/acs2/needle_secs"))

defineProperty("LK2", globalPropertyi("tu-154/gauges/acs2/left_knob_press"))
defineProperty("RK2", globalPropertyi("tu-154/gauges/acs2/right_knob_press"))
defineProperty("flag_pos_2", globalPropertyi("tu-154/gauges/acs2/flag_pos"))

-- clock 3 - engineer
defineProperty("needle_hours_3", globalPropertyf("tu-154/gauges/acs3/needle_hours"))
defineProperty("needle_mins_3", globalPropertyf("tu-154/gauges/acs3/needle_mins"))

defineProperty("flight_timer_hours_3", globalPropertyf("tu-154/gauges/acs3/flight_timer_hours"))
defineProperty("flight_timer_mins_3", globalPropertyf("tu-154/gauges/acs3/flight_timer_mins"))

defineProperty("stopwatch_mins_3", globalPropertyf("tu-154/gauges/acs3/stopwatch_mins"))
defineProperty("needle_secs_3", globalPropertyf("tu-154/gauges/acs3/needle_secs"))

defineProperty("LK3", globalPropertyi("tu-154/gauges/acs3/left_knob_press"))
...
-- The timeline the flight timers and the stopwatches run on. Advanced by
-- frame_time in update(), so it stops on pause and follows time acceleration
-- exactly like the main hands, which run on sim/time/zulu_time_sec. These used
-- to run on sim/time/total_running_time_sec, which does neither -- after any
-- pause the two halves of the same instrument disagreed. Only differences
-- against it are used, so the origin is arbitrary.
local run_clock = 0
...
if knob_summ ~= knob_last then playSample(btn_click, false)
	...
	-- set clock modes
	local sim_time = run_clock  -- gated clock, see run_clock above
